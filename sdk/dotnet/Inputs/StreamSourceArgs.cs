...
namespace Pulumi.Jetstream.Inputs
{
    ...
    public sealed class StreamSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("external")]
        public Input<Inputs.StreamSourceExternalArgs>? External { get; set; }
        ...
        private InputList<Inputs.StreamSourceSubjectTransformArgs>? _subjectTransforms;

        /// <summary>
        /// The subject filtering sources and associated destination transforms
        /// </summary>
        public InputList<Inputs.StreamSourceSubjectTransformArgs> SubjectTransforms
        {
            get => _subjectTransforms ?? (_subjectTransforms = new InputList<Inputs.StreamSourceSubjectTransformArgs>());

...
namespace Pulumi.Jetstream.Inputs
{
    ...
    public sealed class StreamMirrorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Streams replicated from other accounts
        /// </summary>
        [Input("external")]
        public Input<Inputs.StreamMirrorExternalArgs>? External { get; set; }
        ...
        private InputList<Inputs.StreamMirrorSubjectTransformArgs>? _subjectTransforms;

        /// <summary>
        /// The subject filtering sources and associated destination transforms
        /// </summary>
        public InputList<Inputs.StreamMirrorSubjectTransformArgs> SubjectTransforms
        {
            get => _subjectTransforms ?? (_subjectTransforms = new InputList<Inputs.StreamMirrorSubjectTransformArgs>());
            set => _subjectTransforms = value;
        }

        public StreamMirrorArgs()
        {
        }
        public static new StreamMirrorArgs Empty => new StreamMirrorArgs();
    }
}

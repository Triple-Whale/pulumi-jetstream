...
namespace Pulumi.Jetstream
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Jetstream.version.txt");
    ...
    internal sealed class JetstreamResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public JetstreamResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
